...
- **Riwayat singkat:**
  - 2026-09-17 [SELESAI] Audit & implementasi SEO lengkap ke-3 konsep (Hub, Forest, Haven): pasang H1 semantik hero Haven, Open Graph & Twitter Cards, Schema.org JSON-LD (ITService & WebSite), canonical URL, favicon.ico, serta generator robots.txt & sitemap.xml otomatis di build.py.
